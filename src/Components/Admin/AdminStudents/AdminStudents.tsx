...
import { editStudent } from "../../../Redux/Slices/AdminDashboard/AdminDashboardSlice";
...
function AdminStudents() {
  const students = useSelector(
    (state: RootState) => state.adminDashboard.students
  );
    ...
    <>
      <div className="dashboard-header">
        <div className="dashboard-title">
          <FaUsers className="dashboard-title-icon" /> Students
        </div>
      </div>
      <div className="user-management">
        ...
        <div className="user-management__list">
          {activeTab === "active" ? (
            <ActiveUsers users={students} />
          ) : (
            <NonActiveUsers users={students} />
          )}
        </div>
      </div>
    </>
...
function ActiveUsers({ users }: { users: User[] }) {
  ...
  async function toggleActive(id: string) {
    ...
    dispatch(editStudent({data:data.data}));
  ...
  return (
    <>
      ...
      {users
        ...
        .map((student, index) => {
          return (
            <div className="user-card" key={student?._id || index}>
